const Discord = require("discord.js"), cooldowns = new Discord.Collection(), db = require("quick.db"), prefix = process.env.prefix, owners = process.env.owners
...
module.exports = async (client, message) => {
  ...
  if (message.channel.id === "CHANNEL ID") { // Verification Text Channel
    ...
    // Verify System
    if (!owners.includes(message.author.id)) { // The owner of the bot cannot get any verification codes.
